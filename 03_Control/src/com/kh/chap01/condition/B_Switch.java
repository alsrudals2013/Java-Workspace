...
public class B_Switch {
	 ...
	 *            break;
	 * ...
	 * default : 실행할 코드 // if~ else문에서 else와같은 역할을 함.
	 *                    // 위의 값1,값2,값n... 앞으로 동등비교를할 대상과 하나도일치하지
	 *                    // 않다면, default내의 실행할코드가 실행된다.
	 * }
	 * 
	 * swith문 자주사용되진 않지만, 사용하는 경우에는 정말 정밀하게 동일한 연산결과가 수행되어야 하는경우
	 * ex) 키보드입력, 마우스입력등.
	 * 
	 */
...
//		}
	...
	public void method2() {
		...
		// 각 과일마다의 가격을 출력( 사과 1000원 , 바나나 2000원, 복숭 5000원)
